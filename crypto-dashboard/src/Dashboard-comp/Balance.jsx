...
const Balance = () => {
  return (
    <div className='flex justify-between max-w-5xl items-center m-6 '>
        <div className='h-[88px] flex items-center gap-16'>
            ...
            <div className="flex self-baseline mt-[37px]">
                {/* <div className='gap-1 text-gray-500 font-semibold '>
                    <p className='text-sm'>Total Portfolio Value</p>
                </div> */}
        ...
        <div className='flex gap-2'>
            ...
            <ButtonSquare name="Withdraw" icon=<HiUpload /> />
        </div>
    </div>
  )
}
